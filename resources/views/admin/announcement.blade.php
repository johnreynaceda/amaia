...
<x-admin-layout>
    {{-- <div class="bg-white p-5 rounded-xl ">
        ...
        <div class="mt-5 bg-green-800 bg-opacity-50 rounded-xl p-5">
            <h1 class="text-4xl text-center uppercase text-gray-800 font-bold">{{ \Carbon\Carbon::now()->format('F Y') }}
            </h1>
            ...
            <div class="flex mt-5 space-x-2 items-start ">
                ...
                <div>
                    <h1 class="2xl:text-4xl font-bold text-white">Package/Delivery Form</h1>
                    <p class=" 2xl:text-lg text-sm text-[#1C4C4E]">
                        This form grants permission for property management or maintenance personnel to enter a
