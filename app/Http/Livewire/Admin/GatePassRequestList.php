...
class GatePassRequestList extends Component implements Tables\Contracts\HasTable
{
    ...
    protected function getTableColumns(): array
    {
        return [
            ...
            TextColumn::make('building')->label('BLDG')->searchable()->sortable(),
            TextColumn::make('unit')->label('UNIT')->searchable()->sortable(),
            TextColumn::make('visitor_name')->label('VISITOR NAME')->searchable()->sortable(),
            TextColumn::make('purpose')->label('PURPOSE')->searchable()->sortable(),
            TextColumn::make('quantity')->label('QTY')->searchable()->sortable(),
